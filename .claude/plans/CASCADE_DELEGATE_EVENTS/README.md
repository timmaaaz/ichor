...
- **Start here:** [`INVESTIGATION.md`](./INVESTIGATION.md) — full map of all 21 action handlers, the two failure mechanisms, the loop problem, design options, and the decision surface.
