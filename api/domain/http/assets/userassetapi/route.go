...
func Routes(app *web.App, cfg Config) {
	...
	app.HandlerFunc(http.MethodPost, version, "/assets/userassets", api.create, authen, ruleAdmin)
	app.HandlerFunc(http.MethodPut, version, "/assets/userassets/{user_asset_id}", api.update, authen, ruleAdmin)
	app.HandlerFunc(http.MethodDelete, version, "/assets/userassets/{user_asset_id}", api.delete, authen, ruleAdmin)
}
