...
func Routes(app *web.App, cfg Config) {
	...
	app.HandlerFunc(http.MethodPost, version, "/assets/tags", api.create, authen, ruleAdmin)
	app.HandlerFunc(http.MethodPut, version, "/assets/tags/{tag_id}", api.update, authen, ruleAdmin)
	app.HandlerFunc(http.MethodDelete, version, "/assets/tags/{tag_id}", api.delete, authen, ruleAdmin)
}
