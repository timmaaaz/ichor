...
var actionTypeMetadata = map[string]actionTypeMeta{
	...
	"approve_inventory_adjustment": {
		...
		Description:    "Approve a pending inventory adjustment, capturing approver and reason for audit trail",
		Category:       "inventory",
		SupportsManual: true,
		IsAsync:        false,
	},
	"reject_inventory_adjustment": {
		...
		Description:    "Reject a pending inventory adjustment, capturing rejector and reason for audit trail",
		Category:       "inventory",
		SupportsManual: true,
		IsAsync:        false,
	},
	"approve_transfer_order": {
		...
		Description:    "Approve a pending transfer order, capturing approver and reason for audit trail",
		Category:       "inventory",
		SupportsManual: true,
		IsAsync:        false,
	},
	"reject_transfer_order": {
		Name:           "Reject Transfer Order",
		Description:    "Reject a pending transfer order, capturing rejector and reason for audit trail",
		Category:       "inventory",
		SupportsManual: true,
		IsAsync:        false,
	},
	"approve_purchase_order": {
		...
		Description:    "Approve a purchase order, capturing approver and date for audit trail",
		Category:       "procurement",
		SupportsManual: true,
		IsAsync:        false,
	},
	"reject_purchase_order": {
		...
		Description:    "Reject a purchase order, capturing rejector and reason for audit trail",
		Category:       "procurement",
		SupportsManual: true,
		IsAsync:        false,
	},
