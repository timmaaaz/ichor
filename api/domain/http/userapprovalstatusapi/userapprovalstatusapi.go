...
type api struct {
	userapprovalstatusapp *userapprovalstatusapp.App
}

func newAPI(userapprovalstatusapp *userapprovalstatusapp.App) *api {
	return &api{
...
func (api *api) create(ctx context.Context, r *http.Request) web.Encoder {
	var app userapprovalstatusapp.NewUserApprovalStatus
...
func (api *api) update(ctx context.Context, r *http.Request) web.Encoder {
	var app userapprovalstatusapp.UpdateUserApprovalStatus
	if err := web.Decode(r, &app); err != nil {
		return errs.New(errs.InvalidArgument, err)
	}
