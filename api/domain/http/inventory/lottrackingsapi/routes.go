...
const (
	RouteTable = "inventory.lot_trackings"
)
...
func Routes(app *web.App, cfg Config) {
	...
	app.HandlerFunc(http.MethodPost, version, "/inventory/lot-trackings", api.create, authen,
		mid.Authorize(cfg.AuthClient, cfg.PermissionsBus, RouteTable, permissionsbus.Actions.Create, auth.RuleAny))

	app.HandlerFunc(http.MethodPut, version, "/inventory/lot-trackings/{lot_id}", api.update, authen,
		mid.Authorize(cfg.AuthClient, cfg.PermissionsBus, RouteTable, permissionsbus.Actions.Update, auth.RuleAny))

	app.HandlerFunc(http.MethodDelete, version, "/inventory/lot-trackings/{lot_id}", api.delete, authen,
