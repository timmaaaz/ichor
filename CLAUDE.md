...
| `docs/arch/testing.md` | touching dbtest.go, docker container setup, NewDatabase, apitest, test container lifecycle, parallel test isolation, authoring a fan-out integration harness (≥10 parallel subtests in one package), scenario harness, ephemeral-port budget questions |
