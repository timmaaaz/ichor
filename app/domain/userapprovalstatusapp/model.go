...
func ToAppUserApprovalStatus(bus userapprovalstatusbus.UserApprovalStatus) UserApprovalStatus {
...
func ToAppUserApprovalStatuses(bus []userapprovalstatusbus.UserApprovalStatus) []UserApprovalStatus {
...
func toBusNewUserApprovalStatus(app NewUserApprovalStatus) (userapprovalstatusbus.NewUserApprovalStatus, error) {
	var iconID uuid.UUID
	var err error

	if iconID, err = uuid.Parse(app.IconID); err != nil {
		return userapprovalstatusbus.NewUserApprovalStatus{}, err
	}

	return userapprovalstatusbus.NewUserApprovalStatus{
		IconID: iconID,
...
func toBusUpdateUserApprovalStatus(app UpdateUserApprovalStatus) (userapprovalstatusbus.UpdateUserApprovalStatus, error) {
	var iconID *uuid.UUID
	var name *string

	if app.IconID != nil {
		if id, err := uuid.Parse(*app.IconID); err != nil {
			return userapprovalstatusbus.UpdateUserApprovalStatus{}, err
		} else {
			iconID = &id
		}
	}
	...
	return userapprovalstatusbus.UpdateUserApprovalStatus{
		IconID: iconID,
		Name:   name,
	}, nil
}
