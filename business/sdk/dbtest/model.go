			...
			Select: tablebuilder.SelectConfig{
				...
				ForeignTables: []tablebuilder.ForeignTable{
					...
					},
					{
						...
						JoinType:         "left",
						Columns: []tablebuilder.ColumnDefinition{
							{Name: "username", Alias: "updated_by_username", TableColumn: "users.username"},
						},
					},
				},
			},
				...
				ForeignTables: []tablebuilder.ForeignTable{
					{
						...
						JoinType:         "left",
						Columns: []tablebuilder.ColumnDefinition{
							{Name: "first_name", Alias: "user_first_name", TableColumn: "users.first_name"},
							{Name: "last_name", Alias: "user_last_name", TableColumn: "users.last_name"},
							{Name: "username", Alias: "username", TableColumn: "users.username"},
						},
					},
					{
						Table:            "users",
						...
						JoinType:         "left",
						Columns: []tablebuilder.ColumnDefinition{
							{Name: "username", Alias: "approved_by_username", TableColumn: "users.username"},
						},
					},
					{
						Table:            "assets",
			...
			Select: tablebuilder.SelectConfig{
				...
				ForeignTables: []tablebuilder.ForeignTable{
					...
					},
					{
						...
						JoinType:         "left",
						Columns: []tablebuilder.ColumnDefinition{
							{Name: "username", Alias: "adjusted_by_username", TableColumn: "users.username"},
						},
					},
					{
						Table:            "users",
			...
			Select: tablebuilder.SelectConfig{
				...
				ForeignTables: []tablebuilder.ForeignTable{
					...
					},
					{
						...
						JoinType:         "left",
						Columns: []tablebuilder.ColumnDefinition{
							{Name: "aisle", Alias: "from_aisle", TableColumn: "inventory_locations.aisle"},
							{Name: "rack", Alias: "from_rack", TableColumn: "inventory_locations.rack"},
						},
						ForeignTables: []tablebuilder.ForeignTable{
							{
								Table:            "warehouses",
								...
								JoinType:         "left",
								Columns: []tablebuilder.ColumnDefinition{
									{Name: "name", Alias: "from_warehouse_name", TableColumn: "warehouses.name"},
								},
							},
						},
					},
					{
						...
						JoinType:         "left",
						Columns: []tablebuilder.ColumnDefinition{
							{Name: "aisle", Alias: "to_aisle", TableColumn: "inventory_locations.aisle"},
							{Name: "rack", Alias: "to_rack", TableColumn: "inventory_locations.rack"},
						},
						ForeignTables: []tablebuilder.ForeignTable{
							{
								Table:            "warehouses",
								...
								JoinType:         "left",
								Columns: []tablebuilder.ColumnDefinition{
									{Name: "name", Alias: "to_warehouse_name", TableColumn: "warehouses.name"},
								},
							},
						},
					},
