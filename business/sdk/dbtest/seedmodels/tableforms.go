...
func GetSupplierFormFields(formID uuid.UUID, entityID uuid.UUID) []formfieldbus.NewFormField {
	return []formfieldbus.NewFormField{
		...
		// Hidden fields with defaults - required by DB but not shown to user
		{FormID: formID, EntityID: entityID, EntitySchema: "procurement", EntityTable: "suppliers", Name: "rating", Label: "Rating", FieldType: "hidden", FieldOrder: 5, Required: false, Config: json.RawMessage(`{"default_value_create": "0", "hidden": true}`)},
		{FormID: formID, EntityID: entityID, EntitySchema: "procurement", EntityTable: "suppliers", Name: "is_active", Label: "Is Active", FieldType: "hidden", FieldOrder: 6, Required: false, Config: json.RawMessage(`{"default_value_create": "true", "hidden": true}`)},
		// Audit field - auto-populated by backend
		{FormID: formID, EntityID: entityID, EntitySchema: "procurement", EntityTable: "suppliers", Name: "created_date", Label: "Created Date", FieldType: "hidden", FieldOrder: 7, Required: false, Config: json.RawMessage(`{"default_value_create": "{{$now}}", "hidden": true}`)},
	}
}
...
func GetPurchaseOrderFormFields(formID uuid.UUID, entityID uuid.UUID) []formfieldbus.NewFormField {
	return []formfieldbus.NewFormField{
		...
		// Required fields not shown in form — auto-populated or defaulted by backend
		{FormID: formID, EntityID: entityID, EntitySchema: "procurement", EntityTable: "purchase_orders", Name: "requested_by", Label: "Requested By", FieldType: "hidden", FieldOrder: 9, Required: false, Config: json.RawMessage(`{"default_value_create": "{{$me}}", "hidden": true}`)},
		{FormID: formID, EntityID: entityID, EntitySchema: "procurement", EntityTable: "purchase_orders", Name: "order_date", Label: "Order Date", FieldType: "hidden", FieldOrder: 10, Required: false, Config: json.RawMessage(`{"default_value_create": "{{$now}}", "hidden": true}`)},
		{FormID: formID, EntityID: entityID, EntitySchema: "procurement", EntityTable: "purchase_orders", Name: "expected_delivery_date", Label: "Expected Delivery", FieldType: "hidden", FieldOrder: 11, Required: false, Config: json.RawMessage(`{"default_value_create": "{{$now}}", "hidden": true}`)},
		{FormID: formID, EntityID: entityID, EntitySchema: "procurement", EntityTable: "purchase_orders", Name: "subtotal", Label: "Subtotal", FieldType: "hidden", FieldOrder: 12, Required: false, Config: json.RawMessage(`{"default_value": "0", "hidden": true}`)},
		{FormID: formID, EntityID: entityID, EntitySchema: "procurement", EntityTable: "purchase_orders", Name: "tax_amount", Label: "Tax Amount", FieldType: "hidden", FieldOrder: 13, Required: false, Config: json.RawMessage(`{"default_value": "0", "hidden": true}`)},
		{FormID: formID, EntityID: entityID, EntitySchema: "procurement", EntityTable: "purchase_orders", Name: "shipping_cost", Label: "Shipping Cost", FieldType: "hidden", FieldOrder: 14, Required: false, Config: json.RawMessage(`{"default_value": "0", "hidden": true}`)},
		{FormID: formID, EntityID: entityID, EntitySchema: "procurement", EntityTable: "purchase_orders", Name: "total_amount", Label: "Total Amount", FieldType: "hidden", FieldOrder: 15, Required: false, Config: json.RawMessage(`{"default_value": "0", "hidden": true}`)},
		{FormID: formID, EntityID: entityID, EntitySchema: "procurement", EntityTable: "purchase_orders", Name: "currency_id", Label: "Currency", FieldType: "hidden", FieldOrder: 16, Required: false, Config: json.RawMessage(`{"entity": "core.currencies", "label_column": "code", "value_column": "id", "default_value_create": "USD", "hidden": true}`)},
	}
}
