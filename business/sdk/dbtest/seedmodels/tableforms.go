...
func GetUserAssetFormFields(formID uuid.UUID, entityID uuid.UUID) []formfieldbus.NewFormField {
	return []formfieldbus.NewFormField{
		...
		{FormID: formID, EntityID: entityID, EntitySchema: "assets", EntityTable: "user_assets", Name: "approval_status_id", Label: "Approval Status", FieldType: "smart-combobox", FieldOrder: 3, Required: true, Config: json.RawMessage(`{"entity": "assets.approval_status", "label_column": "name", "value_column": "id", "default_value_create": "Pending"}`)},
		{FormID: formID, EntityID: entityID, EntitySchema: "assets", EntityTable: "user_assets", Name: "fulfillment_status_id", Label: "Fulfillment Status", FieldType: "smart-combobox", FieldOrder: 4, Required: true, Config: json.RawMessage(`{"entity": "assets.fulfillment_status", "label_column": "name", "value_column": "id", "default_value_create": "Pending"}`)},
...
func GetSalesOrderFormFields(formID uuid.UUID, entityID uuid.UUID) []formfieldbus.NewFormField {
	return []formfieldbus.NewFormField{
		...
		{FormID: formID, EntityID: entityID, EntitySchema: "sales", EntityTable: "orders", Name: "fulfillment_status_id", Label: "Fulfillment Status", FieldType: "smart-combobox", FieldOrder: 4, Required: true, Config: json.RawMessage(`{"entity": "sales.order_fulfillment_statuses", "label_column": "name", "value_column": "id", "default_value_create": "Pending"}`)},
		// Audit fields - auto-populated by backend
...
func GetSalesOrderLineItemFormFields(formID uuid.UUID, entityID uuid.UUID) []formfieldbus.NewFormField {
	return []formfieldbus.NewFormField{
		...
		{FormID: formID, EntityID: entityID, EntitySchema: "sales", EntityTable: "order_line_items", Name: "line_item_fulfillment_status_id", Label: "Fulfillment Status", FieldType: "smart-combobox", FieldOrder: 4, Required: true, Config: json.RawMessage(`{"entity": "sales.line_item_fulfillment_statuses", "label_column": "name", "value_column": "id", "default_value_create": "Pending"}`)},
		// Audit fields - auto-populated by backend
