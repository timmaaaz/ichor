...
const DomainName = "productcategory"
...
const EntityName = "product_categories"
...
type ActionCreatedParms struct {
	...
	Entity   ProductCategory `json:"entity"`
}
...
// ActionCreatedData constructs delegate data for product category creation events.
func ActionCreatedData(pc ProductCategory) delegate.Data {
	params := ActionCreatedParms{
		EntityID: pc.ProductCategoryID,
...
type ActionUpdatedParms struct {
	...
	UserID       uuid.UUID       `json:"userID"`
	Entity       ProductCategory `json:"entity"`
	BeforeEntity ProductCategory `json:"beforeEntity,omitempty"`
}
...
// ActionUpdatedData constructs delegate data for product category update events.
func ActionUpdatedData(before, after ProductCategory) delegate.Data {
	params := ActionUpdatedParms{
		EntityID:     after.ProductCategoryID,
		UserID:       uuid.Nil, // Reference table - no user tracking
		Entity:       after,
		BeforeEntity: before,
	}
...
// ActionDeletedData constructs delegate data for product category deletion events.
func ActionDeletedData(pc ProductCategory) delegate.Data {
