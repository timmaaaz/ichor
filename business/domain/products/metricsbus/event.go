...
// ActionCreatedData constructs delegate data for metric creation events.
func ActionCreatedData(metric Metric) delegate.Data {
...
type ActionUpdatedParms struct {
	...
	UserID       uuid.UUID `json:"userID"`
	Entity       Metric    `json:"entity"`
	BeforeEntity Metric    `json:"beforeEntity,omitempty"`
}
...
// ActionUpdatedData constructs delegate data for metric update events.
func ActionUpdatedData(before, after Metric) delegate.Data {
	params := ActionUpdatedParms{
		EntityID:     after.MetricID,
		UserID:       uuid.Nil, // Reference table - no user tracking
		Entity:       after,
		BeforeEntity: before,
	}
...
// ActionDeletedData constructs delegate data for metric deletion events.
func ActionDeletedData(metric Metric) delegate.Data {
