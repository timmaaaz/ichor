...
const DomainName = "inventoryitem"
...
const EntityName = "inventory_items"
...
type ActionCreatedParms struct {
	...
	Entity   InventoryItem `json:"entity"`
}
...
// ActionCreatedData constructs delegate data for inventory item creation events.
func ActionCreatedData(inventoryItem InventoryItem) delegate.Data {
...
type ActionUpdatedParms struct {
	...
	UserID       uuid.UUID     `json:"userID"`
	Entity       InventoryItem `json:"entity"`
	BeforeEntity InventoryItem `json:"beforeEntity,omitempty"`
}
...
// ActionUpdatedData constructs delegate data for inventory item update events.
func ActionUpdatedData(before, after InventoryItem) delegate.Data {
...
// ActionDeletedData constructs delegate data for inventory item deletion events.
func ActionDeletedData(inventoryItem InventoryItem) delegate.Data {
