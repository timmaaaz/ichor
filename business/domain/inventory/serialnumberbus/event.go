...
const EntityName = "serial_numbers"
...
type ActionCreatedParms struct {
	...
	Entity   SerialNumber `json:"entity"`
}
...
// ActionCreatedData constructs delegate data for serial number creation events.
func ActionCreatedData(sn SerialNumber) delegate.Data {
	params := ActionCreatedParms{
		EntityID: sn.SerialID,
...
type ActionUpdatedParms struct {
	...
	UserID       uuid.UUID    `json:"userID"`
	Entity       SerialNumber `json:"entity"`
	BeforeEntity SerialNumber `json:"beforeEntity,omitempty"`
}
...
// ActionUpdatedData constructs delegate data for serial number update events.
func ActionUpdatedData(before, after SerialNumber) delegate.Data {
	params := ActionUpdatedParms{
		EntityID:     after.SerialID,
		UserID:       uuid.Nil, // Reference table - no user tracking
		Entity:       after,
		BeforeEntity: before,
	}
...
// ActionDeletedData constructs delegate data for serial number deletion events.
func ActionDeletedData(sn SerialNumber) delegate.Data {
