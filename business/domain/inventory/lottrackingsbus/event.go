...
const EntityName = "lot_trackings"
...
type ActionCreatedParms struct {
	...
	Entity   LotTrackings `json:"entity"`
}
...
// ActionCreatedData constructs delegate data for lot tracking creation events.
func ActionCreatedData(lt LotTrackings) delegate.Data {
...
type ActionUpdatedParms struct {
	...
	UserID       uuid.UUID    `json:"userID"`
	Entity       LotTrackings `json:"entity"`
	BeforeEntity LotTrackings `json:"beforeEntity,omitempty"`
}
...
// ActionUpdatedData constructs delegate data for lot tracking update events.
func ActionUpdatedData(before, after LotTrackings) delegate.Data {
	params := ActionUpdatedParms{
		EntityID:     after.LotID,
		UserID:       uuid.Nil, // Reference table - no user tracking
		Entity:       after,
		BeforeEntity: before,
	}
...
// ActionDeletedData constructs delegate data for lot tracking deletion events.
func ActionDeletedData(lt LotTrackings) delegate.Data {
