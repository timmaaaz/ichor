...
// ActionCreatedData constructs delegate data for office creation events.
func ActionCreatedData(office Office) delegate.Data {
...
type ActionUpdatedParms struct {
	...
	UserID       uuid.UUID `json:"userID"`
	Entity       Office    `json:"entity"`
	BeforeEntity Office    `json:"beforeEntity,omitempty"`
}
...
// ActionUpdatedData constructs delegate data for office update events.
func ActionUpdatedData(before, after Office) delegate.Data {
...
// ActionDeletedData constructs delegate data for office deletion events.
func ActionDeletedData(office Office) delegate.Data {
