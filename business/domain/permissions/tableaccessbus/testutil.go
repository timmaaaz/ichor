...
func TestSeedTableAccess(ctx context.Context, roleIDs uuid.UUIDs, api *Business) ([]TableAccess, error) {
	...
	newTAs := []NewTableAccess{
		...
		{RoleID: uuid.Nil, TableName: "view_products", CanCreate: true, CanRead: true, CanUpdate: true, CanDelete: true},
		...
		{RoleID: uuid.Nil, TableName: "inventory_products", CanCreate: true, CanRead: true, CanUpdate: true, CanDelete: true},
