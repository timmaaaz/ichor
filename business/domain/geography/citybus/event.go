...
// ActionCreatedData constructs delegate data for city creation events.
func ActionCreatedData(city City) delegate.Data {
...
type ActionUpdatedParms struct {
	...
	UserID       uuid.UUID `json:"userID"`
	Entity       City      `json:"entity"`
	BeforeEntity City      `json:"beforeEntity,omitempty"`
}
...
// ActionUpdatedData constructs delegate data for city update events.
func ActionUpdatedData(before, after City) delegate.Data {
...
// ActionDeletedData constructs delegate data for city deletion events.
func ActionDeletedData(city City) delegate.Data {
