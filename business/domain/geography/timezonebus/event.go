...
// ActionCreatedData constructs delegate data for timezone creation events.
func ActionCreatedData(tz Timezone) delegate.Data {
...
// ActionDeletedData constructs delegate data for timezone deletion events.
func ActionDeletedData(tz Timezone) delegate.Data {
