...
// ActionCreatedData constructs delegate data for street creation events.
func ActionCreatedData(street Street) delegate.Data {
...
// ActionDeletedData constructs delegate data for street deletion events.
func ActionDeletedData(street Street) delegate.Data {
