...
const DomainName = "purchaseorderstatus"
...
const EntityName = "purchase_order_statuses"
...
type ActionCreatedParms struct {
	...
	Entity   PurchaseOrderStatus `json:"entity"`
}
...
// ActionCreatedData constructs delegate data for purchase order status creation events.
func ActionCreatedData(pos PurchaseOrderStatus) delegate.Data {
...
type ActionUpdatedParms struct {
	...
	UserID       uuid.UUID           `json:"userID"`
	Entity       PurchaseOrderStatus `json:"entity"`
	BeforeEntity PurchaseOrderStatus `json:"beforeEntity,omitempty"`
}
...
// ActionUpdatedData constructs delegate data for purchase order status update events.
func ActionUpdatedData(before, after PurchaseOrderStatus) delegate.Data {
...
// ActionDeletedData constructs delegate data for purchase order status deletion events.
func ActionDeletedData(pos PurchaseOrderStatus) delegate.Data {
