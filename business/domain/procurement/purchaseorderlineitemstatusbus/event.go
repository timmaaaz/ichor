...
const DomainName = "purchaseorderlineitemstatus"
...
const EntityName = "purchase_order_line_item_statuses"
...
type ActionCreatedParms struct {
	...
	Entity   PurchaseOrderLineItemStatus `json:"entity"`
}
...
// ActionCreatedData constructs delegate data for purchase order line item status creation events.
func ActionCreatedData(polis PurchaseOrderLineItemStatus) delegate.Data {
...
type ActionUpdatedParms struct {
	...
	UserID       uuid.UUID                   `json:"userID"`
	Entity       PurchaseOrderLineItemStatus `json:"entity"`
	BeforeEntity PurchaseOrderLineItemStatus `json:"beforeEntity,omitempty"`
}
...
// ActionUpdatedData constructs delegate data for purchase order line item status update events.
func ActionUpdatedData(before, after PurchaseOrderLineItemStatus) delegate.Data {
...
// ActionDeletedData constructs delegate data for purchase order line item status deletion events.
func ActionDeletedData(polis PurchaseOrderLineItemStatus) delegate.Data {
