...
// The binding ID is generated by the business layer (matching the Create
// flow's house pattern); this method is a thin SQL boundary. New active
// bindings leave unbound_at NULL; the EXCLUDE constraint
...
func (s *Store) BindContainer(ctx context.Context, binding ordersbus.OrderContainerBinding) (ordersbus.OrderContainerBinding, error) {
	...
	row := dbOrderContainerBinding{
		...
		ContainerLabelID: binding.ContainerLabelID,
