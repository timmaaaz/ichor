...
var orderByFields = map[string]string{
	...
	orderlineitemsbus.OrderByDescription:                   "description",
	orderlineitemsbus.OrderByQuantity:                      "quantity",
	orderlineitemsbus.OrderByUnitPrice:                     "unit_price",
	orderlineitemsbus.OrderByDiscount:                      "discount",
	orderlineitemsbus.OrderByDiscountType:                  "discount_type",
	orderlineitemsbus.OrderByLineTotal:                     "line_total",
