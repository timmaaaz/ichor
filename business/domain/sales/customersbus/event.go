...
// ActionCreatedData constructs delegate data for customer creation events.
func ActionCreatedData(customer Customers) delegate.Data {
...
type ActionUpdatedParms struct {
	...
	UserID       uuid.UUID `json:"userID"`
	Entity       Customers `json:"entity"`
	BeforeEntity Customers `json:"beforeEntity,omitempty"`
}
...
// ActionUpdatedData constructs delegate data for customer update events.
func ActionUpdatedData(before, after Customers) delegate.Data {
...
// ActionDeletedData constructs delegate data for customer deletion events.
// Note: For delete, we use UpdatedBy as the user who performed the delete.
func ActionDeletedData(customer Customers) delegate.Data {
	params := ActionDeletedParms{
		EntityID: customer.ID,
		UserID:   customer.UpdatedBy, // UpdatedBy tracks who performed the delete
		Entity:   customer,
	}
