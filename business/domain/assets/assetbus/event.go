...
// ActionCreatedData constructs delegate data for asset creation events.
func ActionCreatedData(asset Asset) delegate.Data {
...
type ActionUpdatedParms struct {
	...
	UserID       uuid.UUID `json:"userID"`
	Entity       Asset     `json:"entity"`
	BeforeEntity Asset     `json:"beforeEntity,omitempty"`
}
...
// ActionUpdatedData constructs delegate data for asset update events.
func ActionUpdatedData(before, after Asset) delegate.Data {
...
// ActionDeletedData constructs delegate data for asset deletion events.
func ActionDeletedData(asset Asset) delegate.Data {
