...
// ActionCreatedData constructs delegate data for user asset creation events.
func ActionCreatedData(userAsset UserAsset) delegate.Data {
	params := ActionCreatedParms{
		EntityID: userAsset.ID,
...
type ActionUpdatedParms struct {
	...
	UserID       uuid.UUID `json:"userID"`
	Entity       UserAsset `json:"entity"`
	BeforeEntity UserAsset `json:"beforeEntity,omitempty"`
}
...
// ActionUpdatedData constructs delegate data for user asset update events.
func ActionUpdatedData(before, after UserAsset) delegate.Data {
...
// ActionDeletedData constructs delegate data for user asset deletion events.
func ActionDeletedData(userAsset UserAsset) delegate.Data {
