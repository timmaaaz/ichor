...
// ActionCreatedData constructs delegate data for asset type creation events.
func ActionCreatedData(assetType AssetType) delegate.Data {
...
type ActionUpdatedParms struct {
	...
	UserID       uuid.UUID `json:"userID"`
	Entity       AssetType `json:"entity"`
	BeforeEntity AssetType `json:"beforeEntity,omitempty"`
}
...
// ActionUpdatedData constructs delegate data for asset type update events.
func ActionUpdatedData(before, after AssetType) delegate.Data {
...
// ActionDeletedData constructs delegate data for asset type deletion events.
func ActionDeletedData(assetType AssetType) delegate.Data {
