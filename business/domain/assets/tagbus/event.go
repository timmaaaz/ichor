...
// ActionCreatedData constructs delegate data for tag creation events.
func ActionCreatedData(tag Tag) delegate.Data {
...
type ActionUpdatedParms struct {
	...
	UserID       uuid.UUID `json:"userID"`
	Entity       Tag       `json:"entity"`
	BeforeEntity Tag       `json:"beforeEntity,omitempty"`
}
...
// ActionUpdatedData constructs delegate data for tag update events.
func ActionUpdatedData(before, after Tag) delegate.Data {
...
// ActionDeletedData constructs delegate data for tag deletion events.
func ActionDeletedData(tag Tag) delegate.Data {
