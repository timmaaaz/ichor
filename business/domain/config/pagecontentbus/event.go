...
const EntityName = "page_contents"
...
type ActionCreatedParms struct {
	...
	Entity   PageContent `json:"entity"`
}
...
// ActionCreatedData constructs delegate data for page content creation events.
func ActionCreatedData(content PageContent) delegate.Data {
...
type ActionUpdatedParms struct {
	...
	UserID       uuid.UUID   `json:"userID"`
	Entity       PageContent `json:"entity"`
	BeforeEntity PageContent `json:"beforeEntity,omitempty"`
}
...
// ActionUpdatedData constructs delegate data for page content update events.
func ActionUpdatedData(before, after PageContent) delegate.Data {
...
// ActionDeletedData constructs delegate data for page content deletion events.
func ActionDeletedData(content PageContent) delegate.Data {
