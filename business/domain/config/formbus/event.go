...
// ActionCreatedData constructs delegate data for form creation events.
func ActionCreatedData(form Form) delegate.Data {
...
type ActionUpdatedParms struct {
	...
	UserID       uuid.UUID `json:"userID"`
	Entity       Form      `json:"entity"`
	BeforeEntity Form      `json:"beforeEntity,omitempty"`
}
...
// ActionUpdatedData constructs delegate data for form update events.
func ActionUpdatedData(before, after Form) delegate.Data {
...
// ActionDeletedData constructs delegate data for form deletion events.
func ActionDeletedData(form Form) delegate.Data {
